...
namespace ItConsultations.Database.Migrations
{
    ...
    [Migration("20250706110951_RemoveUsernamePasswordFromStudent")]
    partial class RemoveUsernamePasswordFromStudent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ItConsultations.Business.Entities.Users;.User", b =>
                {
                    ...
                    b.HasOne("ItConsultations.Business.Entities.Consultation.Coach", null)
                        .WithOne("User")
                        .HasForeignKey("ItConsultations.Business.Entities.Users;.User", "CoachId1");

                    b.HasOne("ItConsultations.Business.Entities.Consultation.Student", null)
                        .WithOne()
                        .HasForeignKey("ItConsultations.Business.Entities.Users;.User", "StudentId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
