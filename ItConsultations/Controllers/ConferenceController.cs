...
namespace ItConsultations.Controllers
{
    ...
    public class ConferenceController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetConferenceByConsId(string consId)
        {
            try
            {
                var conference = await _conferenceService.GetConferenceByConsIdAsync(consId);
        ...
        [HttpPost("{id}/join")]
        public async Task<IActionResult> JoinConference(string id, [FromBody] JoinConferenceDto? joinDto = null)
        {
            try
            {
                var userId = GetCurrentUserId();
                var conference = await _conferenceService.JoinConferenceAsync(id, userId, joinDto?.Password);
        ...
        public async Task<IActionResult> LeaveConference(string id)
        {
            try
            {
                ...
                if (!result)
                {
                    return NotFound("Conference not found or user not a participant");
                }
        ...
        public async Task<IActionResult> AddParticipant(string id, [FromBody] AddParticipantDto dto)
        {
            try
            {
                var result = await _conferenceService.AddParticipantAsync(id, dto.UserId, dto.Role);
        ...
        public async Task<IActionResult> UpdateParticipantRole(string id, long userId, [FromBody] UpdateParticipantRoleDto dto)
        {
            try
            {
                var result = await _conferenceService.UpdateParticipantRoleAsync(id, userId, dto.Role);
